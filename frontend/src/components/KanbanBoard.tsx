...
const DEMO_PROJECTS: Project[] = [
  {
    ...
    codigo_rae: 'OS 07873 (SGF 39090075)',
    ...
    programa: 'SGF 2026 - PADRÃO 110',
    solucao_contratada: 'Faça a gestão financeira e tenha controle do seu dinheiro (Remoto)',
    objetivo_atendimento: 'Atendimento de gestão financeira Sebrae (OS 07873 / SGF 39090075)',
    horas_contratadas: 1,
    horas_realizadas: 0,
    data_prevista_inicio: '2026-08-03',
    data_prevista_fim: '2026-08-03',
    modalidade: 'Remoto',
    valor_consultoria: 250,
    observacoes: 'Colaborador ER: CIOMALIA APARECIDA DE MEDEIROS (ciomaliaam@sebraesp.com.br - 11946160760). Horário a combinar com o consultor.',
    dados_extra: {
